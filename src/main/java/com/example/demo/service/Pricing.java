	...
	public Response pricingEngine() {
		...
		if (request.getChainAssembly() != null) {
			if (request.getChainAssembly().getGears() > 4) {
				return new Response(request.getId(), 0, null, "Max 4 gears Supported");
			}
		...
		if (request.getFrames() != null) {
			if (request.getFrames().getMaterial() != null) {
				...
				if (price != null) {
					...
					return new Response(request.getId(), 0, null, "Frame Material Not Supported");
				}
			} else {
		...
		if (request.getHandleAndBrakes() != null) {
			if (request.getHandleAndBrakes().getHandleMaterial() != null) {
				...
				if (price != null) {
					...
					return new Response(request.getId(), 0, null, "handle Material Not Supported");
				}
			} else {
			...
			if (request.getHandleAndBrakes().getBrakes() != null) {
				...
				if (price != null) {
					...
					return new Response(request.getId(), 0, null, "brakes Material Not Supported");
				}
			} else {
		...
		if (request.getSeating() != null) {
			if (request.getSeating().getSeatingMaterial() != null) {
				...
				if (price != null) {
					...
					return new Response(request.getId(), 0, null, "seating Material Not Supported");
				}
			} else {
		...
		if (request.getWheels() != null) {
			if (request.getWheels().getRimMaterial() != null) {
				...
				if (price != null) {
					...
					return new Response(request.getId(), 0, null, "rim Material Not Supported");
				}
			} else {
			...
			if (request.getWheels().getSpokes() > 40) {
				...
				return new Response(request.getId(), 0, null, "spokes upto 40 are Supported");
